function disp_kills()
    ...
    global kills;
     ...
     pnl = uipanel(fig, 'Title', 'pezzi mangiati', 'Position', [50 50 200 130], 'BackgroundColor', [0.8 0.8 0.8]);
    ...
    lbl_white_score = uilabel(pnl, 'Text', num2str(kills(1)), 'Position', [120 80 50 30], ...
    ...
    lbl_black_score = uilabel(pnl, 'Text', num2str(kills(2)), 'Position', [120 40 50 30], ...
