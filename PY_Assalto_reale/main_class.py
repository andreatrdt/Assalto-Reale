...
class AssaltoRealeGame:
    ...
    def __init__(self):
        ...
        self.king_moved_this_turn: bool = False
    ...
    def reset_game(self):
        ...
        self.king_moved_this_turn = False
        self.turn_counter     = 0
        self.menu_active      = False
        ...
        for m in moves:
            ...
            self.move_history.append({
                ...
                "state": {
                   ...
                   "king_moved":       self.king_moved_this_turn
                },
                "special_control": {
    ...
    def _attempt_move(self, start: Vec2, end: Vec2) -> None:
        ...
        if not piece:
            self.selected = None
            return
        if piece.type == "King" and self.king_moved_this_turn:
            self.selected = None
            return
        ...
        if piece.type == "King":
            self.king_moved_this_turn = True
        # ------------------------------------------------------------
    ...
    def _undo(self) -> None:          # <-- or  undo_move()  in main.py
        ...
        self.king_moved_this_turn = last["state"].get("king_moved", False)
        self.selected = None
