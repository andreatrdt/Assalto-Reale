import { ADJACENT_8, ORTHOGONAL_4 } from "./config";
import { cheb, direction, getPiece, hasPos, inBounds, pieceIdAt, samePos } from "./board";
import type { BoardState, DefendedKingPreview, Vec2 } from "./types";
