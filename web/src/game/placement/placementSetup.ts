// Placement setup helpers extracted from the store: piece inventories, board
// construction, the deterministic placement queue and the Quick-Balanced
// auto-placement heuristic. Pure — no store or React access.
import {
...
import { createSetupSeed } from "../setup/matchConfig";
import type { PendingPlacement, PiecesLeft } from "../state/storeTypes";
